...
const CreateComponent: React.FC = () => {
  ...
  const handleSubmitForm = useCallback(
    ...
    [dispatch, history, token, valueForm.description, valueForm.title]
  );
  return (
    <div>
      create post
      <form onSubmit={handleSubmitForm}>
        <input onChange={handleChange} type="text" name="title" value={valueForm.title} />
        <input onChange={handleChange} type="text" name="description" value={valueForm.description} />

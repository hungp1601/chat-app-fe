...
const TodoProvide: React.FC = ({ children }) => {
  const [todos, setTodos] = React.useState<ITodo[]>([
    ...
    },
    {
      ...
      description:
        'Cứ mỗi độ Đông về, hình ảnh những bông hoa cúc họa mi nhỏ bé, mộc mạc, xinh xắn lại tràn ngập khắp các phố phường Hà Nội. Đi dọc các con đường, bạn có thể dễ dàng bắt gặp bóng dáng những chiếc xe đạp chở đầy những cành hoa tươi, cánh hoa trắng muốt làm nền cho màu vàng của nhụy hoa nổi bật lên, vừa duyên dáng lại vừa giản dị, chân chất. \n',
      status: false,
      time: dateNow,
      image: Anh12,
      color: randomBackgroundColor(),
    },
    {
      ...
      description:
        'Hoa cúc họa mi là loài hoa nhỏ thuộc họ Cúc, có tên gọi tiếng Anh là Daisy. Cúc họa mi được biết đến là loài hoa mọc hoang dã, sống bền bỉ và mạnh mẽ dù thân cây nhỏ bé, tán lá mỏng manh và yếu ớt.',
      status: true,
      time: dateNow,
      image: Anh14,
      color: randomBackgroundColor(),
  ...
  const saveTodo = useCallback(
    (todo: ITodo) => {
      ...
      PushNotification.sendNotification(newTodo.title, newTodo.description, getAccessToken()).then((response) => {
